  ...
  return (
    <View  style={{flex:1}}>
      ...
      <View>
        ...
        <Text style={{fontSize: hp('4%'),fontWeight:700,top: hp('4%')}}> Find Hundreds of Hotels</Text>

        <Text style={{fontWeight:400,fontSize:hp('2%'),top: hp('5%'),textAlign:'center',color:'#A7AEC1'}}>Discover hundreds of hotels that spread across
the world for you.</Text>
        </View>
