  ...
  return (
    <View  style={{flex:1}}>
      ...
      <View>
        ...
        <Text style={{fontSize: hp('4%'),fontWeight:700,top: hp('4%')}}> Lets Discover the World</Text>

        <Text style={{fontWeight:400,fontSize:hp('2%'),top: hp('5%'),textAlign:'center',color:'#A7AEC1'}}>Book your hotel right now for the next level travel.Enjoy your trip!.</Text>
        </View>
        ...
        >
          <Text style={{color:'#fff',textAlign:'center',top:hp ('2%'),fontSize:hp('2%'),fontWeight:700}}>Get Started</Text>
